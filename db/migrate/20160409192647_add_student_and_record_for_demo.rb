class AddStudentAndRecordForDemo < ActiveRecord::Migration
  ...
  def change
    ...
    adam = {first_name: "Adam", last_name: "Ibrahim", student_id: "3333333", email: "adam@concordia.ca", department: "Computer Science", password: "adamibraham123", password_confirmation: "adamibraham123"}
    daniel = {first_name: "Daniel", last_name: "MakarDich", student_id: "4444444", email: "daniel@concordia.ca", department: "Computer Science", password: "daniel123", password_confirmation: "daniel123"}
