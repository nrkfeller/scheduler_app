class AddCourseToDatabase < ActiveRecord::Migration
  ...
  def change
    ...
    COMP.each do |comp|
      CourseDatum.create(name: 'Comp', num: comp[0], title: comp[1], credit: comp[2], prereg: comp[3])
    end
    ...
    ENCS.each do |encs|
      CourseDatum.create(name: 'Encs', num: encs[0], title: encs[1], credit: encs[2])
    end
  end
end
